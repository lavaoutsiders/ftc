Public Class verkoper
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'als  is niet verkoper ook niet admin dan naar login
        ...
        ElseIf Session("niveau") <> "v" And Session("admin") <> 1 Then
            Server.Transfer("~/Account/login.aspx")
        ElseIf Session("niveau") <> "v" And Session("admin") = Nothing Then
            Server.Transfer("~/Account/login.aspx")
        ElseIf Session("niveau") <> "v" And Session("admin") Then
